        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <h2>Draft Treads</h2>
                    ...
                    <?php $dd1 = \App\Models\Treads::orderBy('created_at', 'DESC')->paginate(30); ?>
                    <?php $dd = \App\Models\Treads::where('status', 0)->orderBy('created_at', 'DESC')->paginate(30); ?>
                    ...
                    <?php $dt = \App\Models\Treads::where('status', 0)->get(); ?>
                            <div class="clearfix">
                                ...
                                <div class="d_s_action">
                                    ...
                                    <a href="{{route('adminTreadsPublished')}}">Published ({{count($pt)}})</a>
                                    <a class="active">Drafts ({{count($dt)}})</a>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="card card-plain">
                                  <div class="card-header card-header-warning">
                                    <h4 class="card-title mt-0"> Draft Treads</h4>
                                            ...
                                            @if(count($dd1) > 0)
                                                @foreach($dd as $ui)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{route('treadID', $ui->id)}}" target="_blank"> <button rel="tooltip" title="View Post" class="btn btn-warning">{{\Str::limit($ui->slug, 20)}}</button></a></td>
