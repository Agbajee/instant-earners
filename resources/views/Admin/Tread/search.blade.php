    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    <div class="header">
                        <form method="get" action="{{route('adminSearchTreads')}}">
                            <div class="from_s_a">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            ...
                            <form id="selected_all" action="{{route('adminTSelected')}}" method="post">
                                @csrf
                                ...
                                <tbody>
									...
									@foreach($get_tread as $ui)
										<tr>
											...
											<td width="5%">
												<a title="Delete User" href="{{route('adminTreadsSelected', $ui->id)}}" type="submit" class="btn bg-teal waves-effect" id="s_d_i">
