            ...
            <div class="card-header card-header-primary">
                ...
                <div class="row clearfix">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <?php $dd = \App\Models\User::where('is_verified', 0)->orderBy('created_at', 'DESC')->paginate(30) ?>
                                <div class="table-responsive">
                                    <div class="clearfix">
                                        ...
                                        <div class="d_s_action">
                                            ...
                                            <a class="btn btn-outline-warning" href="{{route('adminUsersVerified')}}">Verified({{count($the_verified)}})</a>
                                            <a class="btn btn-primary">Un-verified ({{count($the_unverified)}})</a>
                                        </div>
                                    ...
                                    <table class="table table-hover dashboard-task-infos">
                                        ...
                                        @foreach($dd as $ui)
                                            <tr>
                                                ...
                                                <td width="15%">
                                                    <a title="Delete User" href="{{route('adminUsID', $ui->id)}}" type="submit" class="btn bg-teal waves-effect" id="s_d_i">
