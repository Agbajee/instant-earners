...
@php
    ...
    $dd = \App\Models\User::whereNotIn('id', $paid_members)->orderBy('created_at', 'DESC')->paginate(30);
    $counter = 1;
@endphp
          ...
          <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 active "  href="{{route('adminUsersUnPaid')}}">
...
@section('scripts')
    <script>
        ...
        $('#selected_all').on('click', function (event) {
            ...
            var re = swal('Wait!','Are you sure you want to perform this action ? click outside the box to cancel', 'info');
            if(re == true){
                return true
            } else{
