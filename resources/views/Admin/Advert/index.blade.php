						...
						<table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 550px;">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{date_to_word($ui->created_at)}}</td>
									<td class="actions">
										<a href="{{route('advertDelete', $ui->id)}}" class="btn btn-sm btn-danger text-light"><i class="bx bx-trash"></i> </a>
										<a href="{{route('advertEdit', $ui->id)}}" class="btn btn-sm btn-info text-light"><i class="bx bx-pen"></i> </a>
									</td>
								</tr>
								@endforeach
							</tbody>
