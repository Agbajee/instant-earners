            ...
            <div class="card-body">
                            ...
                            <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                <div class="nav-wrapper position-relative end-0">
                                  <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                    ...
                                    <li class="nav-item">
                                      <a class="nav-link mb-0 px-5 py-1 "  href="javascript:void(0);">
                                        <span class="ms-1">Search Result for {{$term}}  </span><br>
                                        <div class="badge badge-md badge-circle badge-floating badge-info text-black border-black">{{$users->count()}}</div> Found
                ...
                <table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 750px;">
                    ...
                    @foreach($users as $ui)
                        <tr>
                            <td>{{$counter++}}</td>
                            <td><a href="javascript:void(0);"> {{$ui->fullname}}</a></td>
