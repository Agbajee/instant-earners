        ...
        <div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <?php $dd = \App\Treads::where('status', 0)->where('created_by', Auth::user()->id)->orderBy('created_at', 'DESC')->paginate(30); ?>
                        ...
                        <div class="table-responsive">
                            <div class="clearfix">
                                ...
                                <div class="d_s_action">
                                    ...
                                    <a href="{{route('moderatorTreadsPublished')}}">Published ({{count($pt)}})</a>
