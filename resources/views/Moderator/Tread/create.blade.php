...
@section('content')
<form class="ecommerce-form action-buttons-fixed" method="post" action="{{route('moderatorTreadsCreatePost')}}" enctype='multipart/form-data'>
    @csrf
    <div class="row mt-2">
        <div class="col">
                            ...
                            <div class="tab-content" id="tabContent">
                                <div class="tab-pane fade show active" id="category" role="tabpanel" aria-labelledby="category-tab">
                                    <div class="form-group row align-items-center pb-3">
                                        ...
                                        <div class="col-lg-7 col-xl-6">
                                            <div class="clearfix">
                                            <?php $cats = \App\Category::all()->pluck('name', 'id'); ?>
    ...
    <div class="row action-buttons">
        ...
        <div class="col-12 col-md-auto ms-md-auto mt-3 mt-md-0 ms-auto">
            <a href="#" id="edit_tread" class="delete-button btn btn-danger btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1">
                <i class="bx bx-trash text-4 me-2"></i> Save as Draft
            </a>
        </div>
    </div>
</form>
