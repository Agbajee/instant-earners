                ...
                <div class="main-content-inner">
                    ...
                    <div class="main-content-inner-contet">
                        ...
                        <div class="show_profile_info clearfix">
                            <div class="most-popular-tag-inner clearfix" style="padding: 0 0 20px 0"><a href="{{route('account')}}"> My Account </a> <a href="{{route('editAccount')}}"> Edit Profile </a> <a href="{{route('changePassword')}}" class="active"> Change Password </a> <a href="{{route('support')}}"> Support Ticket </a> </div>
                                ...
                                <div class="clearfix" style="padding: 20px;">
                                    ...
                                    <div class="col-md-10">
                                        <div class="user_info_d">
                                                ...
                                                <button class="custom-btn" type="submit">Change Password</button>
