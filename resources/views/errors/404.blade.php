...
<head>
    ...
    <title>{{ $gt->title }} - 404 page not found</title>
...
<body>
    ...
    <div class="error">
      ...
      <div class="error__description">It looks like you are lost. Find your way back with the link below</div>
      <a href="/" class="error__button error__button--active">Home</a>
