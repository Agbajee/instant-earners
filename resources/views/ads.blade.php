           ...
           <div class="col-lg-8 md-mb-50">
               ...
               <div class="blog-item mb-50">
                  <div class="blog-img">
                     ...
                     <div class="blog-meta">
                           <ul class="btm-cate">
                              ...
                              <li>
                                 <div class="blog-date">
                                       <i class="ri-calendar-line"></i> {{ date_to_word($item->created_at) }}
                                 </div>
                              </li>
                           </ul>
                     </div>
                  ...
                  <div class="blog-content">
                        <h3 class="blog-title"><a href="{{ route('advert.post', $item->slug) }}">{{$item->title}}.</a></h3>
                        <div class="blog-desc">
                           {{ str_limit(strip_tags($item->content), 300, '...') }}
                        </div>
                        <div class="blog-button inner-btn">
                           <a class="blog-btn" href="{{ route('advert.post', $item->slug) }}">Continue Reading
